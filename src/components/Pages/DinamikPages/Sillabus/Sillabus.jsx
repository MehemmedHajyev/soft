    ...
    <div className='silibus-container'>
      ...
      <div className="silibus-grid-container">
        <div className="silibus-grid-container-card">
          <div className="silibus-grid-container-card-content">
            <h2>Beginner Software
              Engineer</h2>
            <ul className='sillabus-list'>
              <li className='item-list-sillabus'>
            ...
            <button className='sillabus-date-btn'>1,5 ay</button>
        </div>

        <button className='sillabus-muraciyyet-btn'>1,5 ay</button>
      </div>
