...
const BASE_URL = 'https://api.softwarevillage.az/api/blogs'
                    ...
                    blogs.map((blog) => (
                        <div className="blog-grid-card">
                            ...
                            <div className="button-date-container">
                                <p className='blog-card-date'>{blog.created_at}</p>
                                <Link to={`/bloq/${blog?.slug}`}>
                                    <button className='blog-card-button' >
                                        <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1.77199 14.6857L7.71484 7.99995L1.77199 1.31424" stroke="#292F36" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </button>
                                </Link>
